...
st.write("""
✔ 사용자기반 협업필터링
- 사용자 기반 협업 필터링(User-based Collaborative Filtering)은 도서 추천 시스템에서 가장 기본적인 방법 중 하나입니다. 이 방법은 사용자 간의 유사도를 계산하고, 비슷한 취향을 가진 사용자들이 선호한 도서를 추천해주는 방식입니다.
""")
...
st.write("""
✔ 아이템기반 협업필터링
- 아이템 기반 협업 필터링(Item-based Collaborative Filtering)은 사용자가 아닌 아이템을 중심으로 유사도를 계산하여 추천하는 방식입니다. 사용자가 평가한 아이템들의 유사도를 계산하여 추천하고자 하는 아이템과 가장 유사한 아이템들을 찾아서 추천합니다.
""")
